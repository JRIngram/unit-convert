    ...
    convertUnit(){
        ...
        try{
            ...
            if(fromUnit === 'g' || fromUnit === 'kg' || fromUnit === 'mg' || fromUnit === 'lb' || fromUnit === 'st'){
                ...
                convertedValue = convertMass(this.state.fromValue, this.state.fromUnit, this.state.toUnit).toPrecision(10);
            }
            if(fromUnit === 'm3' || fromUnit === 'l' || fromUnit === 'ml' || fromUnit === 'pt (imp)' || fromUnit === 'cup (mt)'){
                //Convert to volume if volume unit
                convertedValue = convertVolume(this.state.fromValue, this.state.fromUnit, this.state.toUnit).toPrecision(4);
            }
        }catch(Error){
